...
interface IModalAddImageState {
    styleLocal: boolean;
    msg: string;
}
export default class ModalAddImage extends Component<IModalAddImageProps, IModalAddImageState> {
    input: HTMLInputElement;
    constructor(props: IModalAddImageProps) {
        super(props);
        this.state = {
            styleLocal: true,
            msg: '或选择网络图片'
    ...
    renderUrl() {
        return (
            <div className='modal-type-url'>
                ...
                <button
                    className='confirm'
                    onClick={this.props.onOption.bind(this, this, this.state.styleLocal)}>
                    确认
                 </button>
            </div>
        );
        ...
        return (
            <div className='modal-bg'>
                ...
                <div className='modal-main-body'>
                    ...
                    <div
                        className=''
                        data-action={this.state.styleLocal ? 'to-url' : 'to-local'}
