...
const EditorChangeTitleAction = (title: string) => ({
...
export {
    EditorUploadImageOption,
    EditorNewEditorOption,
    EditorOpenArticleOption,
    EditorOpenTitlesOption,
    EditorChangeTitleAction,
    EditorOnSaveOption
};
